...
export function renderStitchTracker(containerId) {
  ...
  // Header
  html +=
    '<div class="stitch-tracker-hdr">' +
    '<div class="stitch-tracker-title">\uD83E\uDDF5 Flawless Pipeline</div>' +
    '<div class="stitch-tracker-time" id="' +
    containerId +
    '-time">--:--</div>' +
    '</div>'
  ...
  for (var i = 0; i < PIPE5_NAMES.length; i++) {
    ...
    html +=
      '<div class="stitch-stage s-idle" id="' +
      containerId +
      '-stage-' +
      i +
      '">' +
      '<div class="stitch-node">' +
      '<div class="stitch-node-ico">' +
      PIPE5_ICONS[i] +
      '</div>' +
      '</div>' +
      '<div class="stitch-stage-label">' +
      esc(PIPE5_NAMES[i]) +
      '</div>' +
      '<div class="stitch-stage-badge" id="' +
      containerId +
      '-badge-' +
      i +
      '">Waiting</div>' +
  ...
  html +=
    '<div class="stitch-review-panel" id="' +
    containerId +
    '-review">' +
    '<div class="stitch-review-hdr" id="' +
    containerId +
    '-review-toggle">' +
    '<span class="stitch-review-title">\uD83D\uDD0D GPT-4o Review Findings</span>' +
    '<span class="stitch-review-arrow">\u25B6</span>' +
    '</div>' +
    '<div class="stitch-review-body" id="' +
    containerId +
  ...
  // Build time estimate
  html +=
    '<div class="stitch-estimate" id="' +
    containerId +
    '-estimate">' +
    '<span class="stitch-estimate-label">Estimated build time</span>' +
    '<span class="stitch-estimate-value" id="' +
    containerId +
    '-eta">--</span>' +
    '</div>'
  html += '</div>'
