...
export function addMsg(cfg) {
  ...
  if (cfg.role === 'user') {
    ...
    if (cfg.type === 'typing') {
      ...
      row.id = cfg.id
      var pNames = cfg.pipelineType === 'website2' ? PIPE4_NAMES : cfg.pipelineType === 'website' ? PIPE3_NAMES : cfg.pipelineType === 'builder2' ? PIPE2_NAMES : PIPE_NAMES
      var pIcons = cfg.pipelineType === 'website2' ? PIPE4_ICONS : cfg.pipelineType === 'website' ? PIPE3_ICONS : cfg.pipelineType === 'builder2' ? PIPE2_ICONS : PIPE_ICONS
