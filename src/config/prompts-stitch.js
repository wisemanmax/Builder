...
export const GPT4O_STITCH_REVIEW = 'Review this single-file HTML app. Return a JSON array of issues: { severity: critical|warning|info, location, description, suggestedFix }\n'
  + '\nAnalyze the provided HTML app and checksReport for:\n'
...
export const SYS_STITCH_FIX1 = 'You are a senior principal engineer performing a repair pass on a single-file HTML app.\n'
  + '\nApply ALL fixes from reviewFindings[]. Do not skip critical or warning items. Preserve the original Stitch design layer.\n'
  + '\nRULES:\n'
...
export const SYS_STITCH_FIX2 = 'You are a senior principal engineer performing a second-pass repair. This is the final repair opportunity.\n'
