...
export const SYS_WEB_DECOMPOSE = 'You are a senior web architect. Given a website description, decompose it into a structured build plan for a React + Vite project.\n'
  ...
  + '}\n'
  + '\nBe specific about components — name each one based on what it actually renders. Include 5-8 realistic content items in data descriptions.'

export const SYS_WEB_SCAFFOLD = 'You are a senior React engineer. Generate the project skeleton for a React + Vite website.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
  + '{ "files": { "path": "content", ... } }\n'
...
export const SYS_WEB_TOKENS = 'You are a senior CSS architect. Generate the complete design token system as global.css for a React + Vite website.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
...
export const SYS_WEB_DATA = 'You are a senior React engineer. Generate the data layer files for a React + Vite website.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
...
export const SYS_WEB_SHARED = 'You are a senior React engineer. Build all shared/leaf UI components for a React + Vite website.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
...
export const SYS_WEB_FEATURES = 'You are a senior React engineer. Build all feature/section components for a React + Vite website.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
...
export const SYS_WEB_LAYOUT = 'You are a senior React engineer. Build the layout components (Header, Footer, and any navigation) for a React + Vite website.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
...
export const SYS_WEB_PAGES = 'You are a senior React engineer. Build all page components for a React + Vite website.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
...
export const SYS_WEB_ROUTING = 'You are a senior React engineer. Wire the final routing for a React + Vite website.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
...
export const SYS_WEB_DOCS = 'You are a technical writer. Generate a comprehensive README.md for a React + Vite website project.\n'
  + '\nReturn ONLY a JSON object (no markdown, no code fences):\n'
...
export const SYS_WEB_PREVIEW = 'You are a senior engineer. Given a multi-file React website, create a single self-contained HTML file that renders a preview of the website.\n'
