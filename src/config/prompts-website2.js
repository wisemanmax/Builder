...
export const SYS_WEB2_RECON = 'You are an expert web analyst. Given a URL, scraped HTML content, description, or screenshots of a website, extract everything needed to recreate it as a single-file HTML website.\n'
...
export const SYS_WEB2_BRAND = 'You are a brand identity extraction specialist. Given recon data from a website analysis (including any raw HTML/CSS), extract precise brand tokens BEFORE any design decisions are made.\n'
  + '\nPROCESS:\n'
...
export const SYS_WEB2_DESIGN = 'You are a senior UI designer. Given brand tokens and a structural map, make all design decisions for recreating a website as a single-file HTML.\n'
  + '\nRULES:\n'
...
export const SYS_WEB2_AUDIT = 'You are a senior code auditor reviewing a single-file HTML website recreation.\n'
