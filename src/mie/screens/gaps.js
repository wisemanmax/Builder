...
export function renderGaps(container, signal) {
  ...
  html +=
    '<p style="font-size:13px;color:var(--mie-text-secondary);line-height:1.6">Borrower segments underserved by competitors, ranked by opportunity score. Click to expand segment details and messaging recommendations.</p>'
  html += '</div>'
  ...
  for (var i = 0; i < sorted.length; i++) {
    ...
    html +=
      '<span style="font-family:var(--fm);font-size:18px;font-weight:700;color:' +
      oppColor +
      '">' +
    ...
    html +=
      '<div style="font-size:11px;font-weight:600;color:var(--mie-text-muted);text-transform:uppercase;letter-spacing:0.05em;margin-bottom:8px">Segment Profile</div>'
    ...
    html +=
      '<div style="margin-top:12px;font-size:11px;font-weight:600;color:var(--mie-text-muted);text-transform:uppercase;letter-spacing:0.05em;margin-bottom:6px">Competitor Gap</div>'
...
function stat(label, value, color) {
  return (
    '<div class="mie-seg-stat"><span class="mie-seg-stat-label">' +
    label +
    '</span><span class="mie-seg-stat-val" style="color:' +
    color +
    '">' +
    value +
    '</span></div>'
