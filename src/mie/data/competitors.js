    ...
    products: [
      {
        ...
        variableAprMax: 16.7,
        loanMin: 1000,
        loanMax: null, // Full COA
        repaymentTermsMin: 10,
        repaymentTermsMax: 20,
        originationFee: 0,
...
export const MAP_DIMENSIONS = [
  {
    ...
    label: 'Accessibility vs Value',
    xKey: 'accessibility',
    yKey: 'value',
    xLabel: 'Approval Accessibility',
    yLabel: 'Borrower Value',
  },
  {
    id: 'pricing-trust',
    label: 'Pricing vs Trust',
    xKey: 'pricing',
    yKey: 'trust',
    xLabel: 'Pricing Competitiveness',
    yLabel: 'Brand Trust',
  },
  {
    id: 'ux-trust',
    label: 'Digital Experience vs Trust',
    xKey: 'ux',
    yKey: 'trust',
    xLabel: 'Digital Experience Quality',
    yLabel: 'Institutional Credibility',
  },
  {
    id: 'accessibility-pricing',
    label: 'Accessibility vs Pricing',
    xKey: 'accessibility',
    yKey: 'pricing',
    xLabel: 'Approval Accessibility',
    yLabel: 'Pricing Competitiveness',
  },
...
export const COMPETITIVE_ALERTS = [
  {
    ...
    description:
      'Rate & Fee Fairness score dropped from 3.2 to 2.4 over 30 days, driven by 47 new complaints about unexpected origination fees.',
  ...
  },
  {
    ...
    action:
      'Monitor impact on their approval speed score. Consider highlighting GradBridge speed for no-cosigner applicants.',
  },
]
